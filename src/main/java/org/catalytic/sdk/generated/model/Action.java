...
public class Action {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, teamName, referenceName, version, appId, name, description, tags, requiredWorkerTags, inputs, outputs, isPublished, metaData, originalActionId, helpDocumentPath, iconSvg, integrationIds, integrationRequired);
  }
