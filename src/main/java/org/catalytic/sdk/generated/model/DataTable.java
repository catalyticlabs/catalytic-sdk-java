...
public class DataTable {
  ...
  **/
  ...
  public DataTable createdByEmail(String createdByEmail) {
   ...
   /**
   * The email of the user who created the table
   * @return createdByEmail
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The email of the user who created the table")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, dataTable.id) &&
        ...
        Objects.equals(this.createdByEmail, dataTable.createdByEmail) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, dataTableId, referenceName, name, teamName, description, columns, isArchived, type, visibility, visibleToUsers, createdByEmail, rowLimit, columnLimit, cellLimit);
  }
