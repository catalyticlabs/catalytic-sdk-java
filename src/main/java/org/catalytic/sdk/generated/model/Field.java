...
public class Field {
  ...
  **/
  ...
  public Field display(FieldDisplayOptions display) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, referenceName, description, example, position, display, fieldType, value, templateValue, defaultValue);
  }
