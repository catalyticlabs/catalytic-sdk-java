...
public class IntegrationsApi {
     ...
     * @param integrationCreationRequest The definition of the Integration to create (optional)
    ...
    /**
     * Create Integration Connection (asynchronously)
     * Create a new Integration Connection
     * @param id The ID of the Integration Definition for which a Connection should be created (required)
     * @param integrationConnectionCreationRequest Request containing information used to create the Integration Connection (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Delete Integration Connection (asynchronously)
     * Delete an Integration Connection
     * @param integrationId The ID of the Integration to which the Integration Connection belongs (required)
     * @param id The ID of the Integration Definition to delete (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * Get Integration Definition (asynchronously)
     * Get Integration Definition by ID
     * @param id The ID of the Integration to get (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Get Integration Connection (asynchronously)
     * Get Integration Connection by ID
     * @param integrationId The ID of the Integration to which the Integration Connection belongs (required)
     * @param id The ID of the Integration Definition to get (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    @Deprecated
    public okhttp3.Call listIntegrationsCall(String pageToken, Integer pageSize, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @Deprecated
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listIntegrationsValidateBeforeCall(String pageToken, Integer pageSize, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listIntegrationsCall(pageToken, pageSize, _callback);
        return localVarCall;
     ...
     */
    @Deprecated
    public IntegrationsPage listIntegrations(String pageToken, Integer pageSize) throws ApiException {
        ApiResponse<IntegrationsPage> localVarResp = listIntegrationsWithHttpInfo(pageToken, pageSize);
        return localVarResp.getData();
    }
     ...
     */
    @Deprecated
    public ApiResponse<IntegrationsPage> listIntegrationsWithHttpInfo(String pageToken, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = listIntegrationsValidateBeforeCall(pageToken, pageSize, null);
     ...
     */
    @Deprecated
    public okhttp3.Call listIntegrationsAsync(String pageToken, Integer pageSize, final ApiCallback<IntegrationsPage> _callback) throws ApiException {

        okhttp3.Call localVarCall = listIntegrationsValidateBeforeCall(pageToken, pageSize, _callback);
        Type localVarReturnType = new TypeToken<IntegrationsPage>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param id The ID of the Integration to update (required)
     * @param integrationUpdateRequest The updates to apply to the Integration (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
