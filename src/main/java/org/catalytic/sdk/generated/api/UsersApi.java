...
import org.catalytic.sdk.generated.model.UserSearchClause;
import org.catalytic.sdk.generated.model.UsersPage;
...
public class UsersApi {
     ...
     * @param pageToken The token representing the result page to get (optional)
     * @param pageSize The page size requested (optional)
     * @param userSearchClause  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call searchUsersCall(String pageToken, Integer pageSize, UserSearchClause userSearchClause, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = userSearchClause;

        // create path and map variables
        String localVarPath = "/api/users/search";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchUsersValidateBeforeCall(String pageToken, Integer pageSize, UserSearchClause userSearchClause, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchUsersCall(pageToken, pageSize, userSearchClause, _callback);
        return localVarCall;

    }

    /**
     * Search through users on team
     * 
     * @param pageToken The token representing the result page to get (optional)
     * @param pageSize The page size requested (optional)
     * @param userSearchClause  (optional)
     ...
     */
    public UsersPage searchUsers(String pageToken, Integer pageSize, UserSearchClause userSearchClause) throws ApiException {
        ApiResponse<UsersPage> localVarResp = searchUsersWithHttpInfo(pageToken, pageSize, userSearchClause);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UsersPage> searchUsersWithHttpInfo(String pageToken, Integer pageSize, UserSearchClause userSearchClause) throws ApiException {
        okhttp3.Call localVarCall = searchUsersValidateBeforeCall(pageToken, pageSize, userSearchClause, null);
        Type localVarReturnType = new TypeToken<UsersPage>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search through users on team (asynchronously)
     * 
     * @param pageToken The token representing the result page to get (optional)
     * @param pageSize The page size requested (optional)
     * @param userSearchClause  (optional)
     ...
     */
    public okhttp3.Call searchUsersAsync(String pageToken, Integer pageSize, UserSearchClause userSearchClause, final ApiCallback<UsersPage> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchUsersValidateBeforeCall(pageToken, pageSize, userSearchClause, _callback);
        Type localVarReturnType = new TypeToken<UsersPage>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
