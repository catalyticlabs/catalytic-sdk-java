...
import org.catalytic.sdk.model.InstancesPage;
...
public class InstancesApi {
     ...
     */
    public okhttp3.Call findInstancesCall(String query, String status, String processId, String runId, String owner, String category, String participatingUsers, String pageToken, Integer pageSize, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call findInstancesValidateBeforeCall(String query, String status, String processId, String runId, String owner, String category, String participatingUsers, String pageToken, Integer pageSize, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = findInstancesCall(query, status, processId, runId, owner, category, participatingUsers, pageToken, pageSize, _callback);
        return localVarCall;
     ...
     */
    public InstancesPage findInstances(String query, String status, String processId, String runId, String owner, String category, String participatingUsers, String pageToken, Integer pageSize) throws ApiException {
        ApiResponse<InstancesPage> localVarResp = findInstancesWithHttpInfo(query, status, processId, runId, owner, category, participatingUsers, pageToken, pageSize);
     ...
     */
    public ApiResponse<InstancesPage> findInstancesWithHttpInfo(String query, String status, String processId, String runId, String owner, String category, String participatingUsers, String pageToken, Integer pageSize) throws ApiException {
        okhttp3.Call localVarCall = findInstancesValidateBeforeCall(query, status, processId, runId, owner, category, participatingUsers, pageToken, pageSize, null);
     ...
     */
    public okhttp3.Call findInstancesAsync(String query, String status, String processId, String runId, String owner, String category, String participatingUsers, String pageToken, Integer pageSize, final ApiCallback<InstancesPage> _callback) throws ApiException {

        okhttp3.Call localVarCall = findInstancesValidateBeforeCall(query, status, processId, runId, owner, category, participatingUsers, pageToken, pageSize, _callback);
        Type localVarReturnType = new TypeToken<InstancesPage>(){}.getType();
